...
function initializeRelationships() {
    ...
    const SensorThreshold = connection_1.default.define('sensor_threshold', {
        id: {
    ...
    sensor_1.Sensor.belongsToMany(threshold_1.Threshold, { through: SensorThreshold });
    threshold_1.Threshold.belongsToMany(sensor_1.Sensor, { through: SensorThreshold });
