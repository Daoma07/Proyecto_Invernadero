...
class RabbitMQConsumer {
    constructor(username, password, host, port, exchangeName, routingKey) {
    ...
    startConsuming() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const queue = yield channel.assertQueue('', { exclusive: false });
                console.log(`Escuchando el topic '${this.routingKey}'.`);
                yield channel.bindQueue(queue.queue, this.exchangeName, this.routingKey);
